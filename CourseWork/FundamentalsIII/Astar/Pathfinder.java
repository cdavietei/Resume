...
public class Pathfinder extends JFrame
{
	...
	diamondgif = Toolkit.getDefaultToolkit().getImage("resources/gem1.gif");
	prepareImage(diamondgif,this);
	mangif = Toolkit.getDefaultToolkit().getImage("resources/man15.gif");
	...
	imagechar[Astar.WATER] =
			Toolkit.getDefaultToolkit().getImage("resources/boat.gif");
	prepareImage(imagechar[Astar.WATER],this);

	imagechar[Astar.DESERT] = Toolkit.getDefaultToolkit().getImage("resources/camel.gif");
	prepareImage(imagechar[Astar.DESERT],this);

	imagechar[Astar.FOREST] = Toolkit.getDefaultToolkit().getImage("resources/bear.gif");
